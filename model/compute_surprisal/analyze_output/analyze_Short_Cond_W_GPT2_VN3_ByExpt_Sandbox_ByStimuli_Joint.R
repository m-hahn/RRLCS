...
ggsave(plot, file="figures/modelRuns.pdf", height=4, width=7)
...
plot = ggplot(data %>% mutate(ContinueTraining = grepl("_TPL", Script)) %>% filter(Experiment=="Experiment2", predictability_weight==1, Region == "V1_0") %>% group_by(ContinueTraining, compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(ContinueTraining~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-WithAndWithoutTP.pdf", height=4, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment1", deletion_rate>=0.3, deletion_rate<=0.7, !grepl("_TPL", Script), !grepl("_co", Condition), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-full-NoTP.pdf", height=8, width=10)


plot = ggplot(data %>% filter(Experiment=="Experiment1", grepl("_TPL", Script), !grepl("_co", Condition), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-full-TP-NoLimit.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment1", !grepl("_TPL", Script), !grepl("_co", Condition), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-full-NoTP-NoLimit.pdf", height=3.5, width=10)
...
plot = plot + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-full-NoLimit_Rectangle.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% mutate(retention_rate=1-deletion_rate) %>% filter(Experiment=="Experiment1", !grepl("_co", Condition), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, retention_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~retention_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-full-NoLimit_Retention.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment2", deletion_rate>=0.3, deletion_rate<=0.7, !grepl("_TPL", Script), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-NoTP.pdf", height=8, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment2", !grepl("_TPL", Script), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-NoTP-NoLimit.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment2", Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-NoLimit.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment2", predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)) %>% group_by() %>% mutate(deletion_rate = 20*(1-deletion_rate)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(1~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-NoLimit_Lambda1_Integer.pdf", height=1.5, width=10)
...
plot = plot + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-NoLimit_Rectangle.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment2", grepl("_TPL", Script), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-TP-NoLimit.pdf", height=3.5, width=10)
...
ggsave(plot, file="figures/model-critical-experiment1-full-NoTP-thatFraction.pdf", height=8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", deletion_rate>=0.3, deletion_rate<=0.7, !grepl("_TPL", Script), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(ThatFractionReweighted=mean(ThatFractionReweighted)), aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + ylim(0,100)
ggsave(plot, file="figures/model-critical-experiment2-full-NoTP-thatFraction.pdf", height=8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", !grepl("_co", Condition), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(ThatFractionReweighted=mean(ThatFractionReweighted)), aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + ylim(0,100)
ggsave(plot, file="figures/model-critical-experiment1-full-NoLimit-thatFraction.pdf", height=5, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(ThatFractionReweighted=mean(ThatFractionReweighted)), aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + ylim(0,100)
ggsave(plot, file="figures/model-critical-experiment2-full-NoLimit-thatFraction.pdf", height=5, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", grepl("_TPL", Script), !grepl("_co", Condition), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(ThatFractionReweighted=mean(ThatFractionReweighted)), aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + ylim(0,100)
ggsave(plot, file="figures/model-critical-experiment1-thatFraction.pdf", height=1.8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", grepl("_TPL", Script), !grepl("_co", Condition), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(ThatFractionReweighted=mean(ThatFractionReweighted)) %>% group_by() %>% mutate(deletion_rate = 20*(1-deletion_rate)), aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + ylim(0,100)
ggsave(plot, file="figures/model-critical-experiment2-thatFraction_Lambda1_Integer.pdf", height=1.8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", grepl("_TPL", Script), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(ThatFractionReweighted=mean(ThatFractionReweighted)), aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + ylim(0,100)
ggsave(plot, file="figures/model-critical-experiment2-thatFraction.pdf", height=1.8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", grepl("_TPL", Script), !grepl("_co", Condition), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1.pdf", height=1.8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", grepl("_TPL", Script), !grepl("_co", Condition), predictability_weight==1, Region == "V1_0")  %>% mutate(deletion_rate=floor(10*deletion_rate)/10) %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-ByTens.pdf", height=1.8, width=5)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", grepl("_TPL", Script), deletion_rate==round(10*deletion_rate)/10,!grepl("_co", Condition), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-tens.pdf", height=1.8, width=5)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", deletion_rate>=0.2, deletion_rate<0.8, grepl("_TPL", Script), !grepl("_co", Condition), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted))  %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)) , aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-average.pdf", height=1.8, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 7, SurprisalReweighted <=11.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-average-points.pdf", height=3.5, width=1.8)
...
#ggsave(plot, file="figures/model-critical-experiment1-average-points_errorbars.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 7, SurprisalReweighted <=11.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-005-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 7, SurprisalReweighted <=11.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-005-points_SQUARE.pdf", height=1.8, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 7, SurprisalReweighted <=11.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-05-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 7, SurprisalReweighted <=11.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-075-055-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 6, SurprisalReweighted <=10.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-075-average-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 6, SurprisalReweighted <=10.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-average-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=ThatFractionReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(ThatFractionReweighted >= 6, ThatFractionReweighted <=10.0), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model ThatFraction") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-ThatFraction-average-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 5.5, SurprisalReweighted <=11.5), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-05-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 5.5, SurprisalReweighted <=11.5), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-005-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 5.5, SurprisalReweighted <=11.5), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-005-points_SQUARE.pdf", height=1.8, width=1.8)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 5.5, SurprisalReweighted <=11.5), alpha=0.2) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-075-056-points.pdf", height=3.5, width=1.8)
...
plot = ggplot(data %>% filter(Experiment == "Experiment1", !grepl("_TPL", Script), !grepl("_co", Condition), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-noTP.pdf", height=1.8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", grepl("_TPL", Script), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2.pdf", height=1.8, width=10)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", grepl("_TPL", Script), predictability_weight==1, Region == "V1_0") %>% mutate(deletion_rate=floor(10*deletion_rate)/10) %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-byTens.pdf", height=1.8, width=5)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", grepl("_TPL", Script), deletion_rate==round(10*deletion_rate)/10, predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-tens.pdf", height=1.8, width=5)


plot = ggplot(data %>% filter(Experiment == "Experiment2", !grepl("_TPL", Script), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-noTP.pdf", height=1.8, width=5)
...
plot = ggplot(data %>% filter(Experiment == "Experiment2", deletion_rate>=0.2, deletion_rate<0.8, grepl("_TPL", Script), predictability_weight==1, Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted))  %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)) , aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-average.pdf", height=1.8, width=1.8)
   ...
   plot = ggplot(dataSmoothed %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))
ggsave(plot, file="figures/model-critical-experiment1-smoothed.pdf", height=1.8, width=10)
   ...
   plot = ggplot(dataSmoothed %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(SurprisalReweighted=mean(SurprisalReweighted)), aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))
ggsave(plot, file="figures/model-critical-experiment2-smoothed.pdf", height=1.8, width=10)
...
plot = ggplot(data0, aes(x=Ratio, y=SurprisalReweighted, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F)  + geom_point(data = data0 %>% filter(SurprisalReweighted >= 5.5, SurprisalReweighted <=11.5), alpha=0.05) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Model Surprisal") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF"))  + facet_wrap(~ID)
ggsave(plot, file="figures/model-critical-experiment2-allRuns-05-1.pdf", height=7, width=7)
...
plot = ggplot(data %>% filter(Experiment=="Experiment1", !grepl("_co", Condition), Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(Surprisal=mean(Surprisal)), aes(x=Ratio, y=Surprisal, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal (Without Importance Sampling)") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment1-full-NoLimit-NoImportanceReweighting.pdf", height=3.5, width=10)
...
plot = ggplot(data %>% filter(Experiment=="Experiment2", Region == "V1_0") %>% group_by(compatible, HasSCHasRC, HasSC, HasRC, predictability_weight, deletion_rate, Condition, Noun, Ratio) %>% summarise(Surprisal=mean(Surprisal)), aes(x=Ratio, y=Surprisal, group=Condition, color=HasSCHasRC)) + geom_smooth(method="lm", aes(linetype=compatible), se=F) + facet_grid(predictability_weight~deletion_rate) + theme_bw() + theme(legend.position = "none") + xlab("Embedding Bias") + ylab("Average Surprisal (Without Importance Sampling)") + scale_color_manual(values = c("FALSE_FALSE" = "#F8766D",
                                "TRUE_FALSE"="#00BA38",
                                "TRUE_TRUE"="#619CFF")) 
ggsave(plot, file="figures/model-critical-experiment2-full-NoLimit-NoImportanceReweighting.pdf", height=3.5, width=10)
